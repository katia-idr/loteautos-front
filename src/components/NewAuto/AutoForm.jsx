...
export const AutoForm = () => {
        ...
        const getLotes = async () => {
            try {
                const res = await fetch(
                    `${process.env.REACT_APP_API_URL}/lotes`,
                    {
                        headers: {
                            Authorization: token,
                        },
    ...
    return (
        <>
            <p className="pnewauto">
                Introduce los datos necesarios para agregar un vehículo a la
                base de datos.
            </p>
            <form
                id="datosAuto"
            ...
            >
                <ul>
                    ...
                    <li>
                        ...
                        <label className="doslabel" htmlFor="dobletraccion">
                            Si
                        </label>
                        <input
                            id="dobletraccion"
                        ...
                        <label className="treslabel" htmlFor="dobletraccion">
                            No
                        </label>
                        <input
                            id="dobletraccion"
                    ...
                    <li>
                        ...
                        <label className="doslabel" htmlFor="adquisicion">
                            Compra
                        </label>
                        <input
                            id="adquisicion"
                        ...
                        <label className="treslabel" htmlFor="adquisicion">
                            Consigna
                        </label>
                        <input
                            id="adquisicion"
                            ...
                            {maxImages > 0 ? (
                                <>
                                    ...
                                    <label className="button" htmlFor="image">
                                        Selecciona hasta {maxImages} imágenes
                                        más. Haz click aquí.
                                    </label>
                                </>
                            ) : null}
